...
echo Building TwoMinuteExample project...
msbuild "TwoMinuteExample.dproj" /t:Build /p:Configuration=Platform=Win32;PRODUCTVERSION=%PRODUCTVERSION%;DCC_Define=DEBUG
